    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-500">Erstelle deinen Account</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4 rounded-xl bg-white p-6 shadow-md">
          <h2 className="text-lg font-semibold text-gray-800">Registrieren</h2>
          ...
          <p className="text-center text-sm text-gray-500">
            Bereits registriert?{" "}
            <Link to="/login" className="text-gridbert-600 hover:underline">
              Anmelden
            </Link>
          </p>
        </form>
