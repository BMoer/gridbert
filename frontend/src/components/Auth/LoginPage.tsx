      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2" style={{ color: "var(--warm-grau)", fontFamily: "var(--font-body)" }}>
            Dein persönlicher Energie-Agent
          </p>
        </div>
        ...
        >
          <h2 className="text-lg font-semibold" style={{ color: "var(--ink)" }}>Anmelden</h2>
          ...
          <p className="text-center text-sm" style={{ color: "var(--warm-grau)" }}>
            Noch kein Konto?{" "}
            <Link to="/register" style={{ color: "var(--terracotta)" }} className="hover:underline">
              Registrieren
            </Link>
          </p>
        </form>
